...
// Copyright (c) 2015-2017 The JEW developers
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1509031998, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 49472;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // JEW starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // JEW: 1 day
        nTargetSpacing = 1 * 60;  // JEW: 1 minute
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "U.S. News & World Report Nov 03 2017";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1509739494;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 411539;
...
const int SCRYPT_SCRATCHPAD_SIZE = 131072 + 63;
        ...
        assert(hashGenesisBlock == uint256("0x9ca148af67d312fd35343978d0f33d6353f9280329c8c34dbd75ed2f80ee45ff"));
        //assert(genesis.hashMerkleRoot == uint256("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));

        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "shekel.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        // Testnet shekel BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet shekel BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet shekel BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Shekel: 1 day
        nTargetSpacing = 1 * 60;        // Shekel: 1 minutes
